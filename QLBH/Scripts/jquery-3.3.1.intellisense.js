intellisense.annotate(jQuery, {
  ...
  'boxModel': function() {
    /// <summary>Deprecated in jQuery 1.3 (see jQuery.support). States if the current page, in the user's browser, is being rendered using the W3C ~/Content/assets/css Box Model.</summary>
  ...
  '~/Content/assets/cssHooks': function() {
    /// <summary>Hook directly into jQuery to override how particular ~/Content/assets/css properties are retrieved or set, normalize ~/Content/assets/css property naming, or create custom properties.</summary>
    /// <returns type="Object" />
  },
  'data': function() {
    /// <signature>
...
intellisense.annotate(jQuery.fn, {
  ...
  'animate': function() {
    /// <signature>
    ///   <summary>Perform a custom animation of a set of ~/Content/assets/css properties.</summary>
    ///   <param name="properties" type="PlainObject">An object of ~/Content/assets/css properties and values that the animation will move toward.</param>
  ...
  '~/Content/assets/css': function() {
    /// <signature>
    ///   <summary>Set one or more ~/Content/assets/css properties for the set of matched elements.</summary>
    ///   <param name="propertyName" type="String">A ~/Content/assets/css property name.</param>
  ...
  'height': function() {
    /// <signature>
    ///   <summary>Set the ~/Content/assets/css height of every matched element.</summary>
  ...
  'init': function() {
    /// <signature>
    ///   <summary>Accepts a string containing a ~/Content/assets/css selector which is then used to match a set of elements.</summary>
  ...
  'width': function() {
    /// <signature>
    ///   <summary>Set the ~/Content/assets/css width of each element in the set of matched elements.</summary>
